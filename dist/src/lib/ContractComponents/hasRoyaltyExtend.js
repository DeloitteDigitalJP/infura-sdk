...
var HasRoyaltyExtend = /** @class */ (function () {
    function HasRoyaltyExtend() {
    }
    /**
     ...
     * @returns void
     */
    HasRoyaltyExtend.prototype.setContract = function (contract) {
     ...
     */
    HasRoyaltyExtend.prototype.setDefaultRoyalty = function (params) {
            ...
            return __generator(this, function (_a) {
                if (!this.contractDeployed && !this.contractAddress) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.HASROYALTYEXTEND_SETDEFAULTROYALTY,
                    });
                }
                ...
                try {
                    ...
                    return [2 /*return*/, this.contractDeployed.setDefaultRoyalty(params.publicAddress, params.fee, options)];
                }
                catch (error) {
     ...
     * @returns {Promise<ethers.providers.TransactionResponse>} - Transaction
     */
    HasRoyaltyExtend.prototype.deleteDefaultRoyalty = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                if (!this.contractDeployed && !this.contractAddress) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.HASROYALTYEXTEND_DELETEDEFAULTROYALTY,
                    });
                }
                try {
                    options = { gasLimit: constants_1.GAS_LIMIT };
                    options = (0, utils_1.addGasPriceToOptions)(options, params.gas);
                    return [2 /*return*/, this.contractDeployed.deleteDefaultRoyalty(options)];
                }
                catch (error) {
                    return [2 /*return*/, Logger_1.log.throwError(Logger_1.Logger.message.ethers_error, Logger_1.Logger.code.NETWORK, {
                            location: Logger_1.Logger.location.HASROYALTYEXTEND_DELETEDEFAULTROYALTY,
     ...
     * @returns {Promise<ethers.providers.TransactionResponse>} - Transaction
     */
    HasRoyaltyExtend.prototype.setTokenRoyalty = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                if (!this.contractDeployed && !this.contractAddress) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.HASROYALTYEXTEND_SETTOKENROYALTY,
                    });
                }
                ...
                try {
                    options = { gasLimit: constants_1.GAS_LIMIT };
                    options = (0, utils_1.addGasPriceToOptions)(options, params.gas);
                    return [2 /*return*/, this.contractDeployed.setTokenRoyalty(params.tokenId, params.publicAddress, params.fee, options)];
                }
                catch (error) {
                    return [2 /*return*/, Logger_1.log.throwError(Logger_1.Logger.message.ethers_error, Logger_1.Logger.code.NETWORK, {
                            location: Logger_1.Logger.location.HASROYALTYEXTEND_SETTOKENROYALTY,
     ...
     * @returns {Promise<ethers.providers.TransactionResponse>} - Transaction
     */
    HasRoyaltyExtend.prototype.resetTokenRoyalty = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                if (!this.contractDeployed && !this.contractAddress) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.HASROYALTYEXTEND_RESETTOKENROYALTY,
                    });
                }
                if (!(0, utils_1.isDefined)(params.tokenId) || !Number.isInteger(params.tokenId) || params.tokenId < 0) {
                    Logger_1.log.throwMissingArgumentError(Logger_1.Logger.message.no_tokenId_supplied, {
                ...
                try {
                    options = { gasLimit: constants_1.GAS_LIMIT };
                    options = (0, utils_1.addGasPriceToOptions)(options, params.gas);
                    return [2 /*return*/, this.contractDeployed.resetTokenRoyalty(params.tokenId, options)];
                }
                catch (error) {
                    return [2 /*return*/, Logger_1.log.throwError(Logger_1.Logger.message.ethers_error, Logger_1.Logger.code.NETWORK, {
                            location: Logger_1.Logger.location.HASROYALTYEXTEND_RESETTOKENROYALTY,
     ...
     */
    HasRoyaltyExtend.prototype.royaltyInfo = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.contractDeployed) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.HASROYALTYEXTEND_ROYALTYINFO,
                    });
                }
                if (!(0, utils_1.isDefined)(params.tokenId) || !Number.isInteger(params.tokenId) || params.tokenId < 0) {
                    Logger_1.log.throwMissingArgumentError(Logger_1.Logger.message.no_tokenId_supplied, {
    ...
    return HasRoyaltyExtend;
}());
exports.default = HasRoyaltyExtend;
//# sourceMappingURL=hasRoyaltyExtend.js.map